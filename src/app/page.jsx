      ...
      <section className="py-16 px-6 bg-[#fcf9cc]">
        <div className="animate__animated animate__fadeIn">
          ...
          <p className="text-base sm:text-lg md:text-xl text-center max-w-3xl mx-auto text-gray-700 mb-12 leading-relaxed">
            At EstatePro, we specialize in connecting you with your dream
            property — whether it’s a cozy family home, a modern apartment, or a
            luxurious villa. Our mission is to simplify real estate for everyone
            by offering trusted listings, expert guidance, and a seamless
